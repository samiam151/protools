...
var Channel = exports.Channel = function () {
    function Channel(context, soundSrc) {
...
},{"./Context.js":2}],2:[function(require,module,exports){
"use strict";
...
var TrackList = exports.TrackList = function () {
    function TrackList() {
    ...
    _createClass(TrackList, [{
        ...
        value: function startTracks() {
            var currentTime = _Context.CONTEXT.currentTime + 5;
...
var _TrackList = require("./AudioComponents/TrackList");
...
function init() {
    var initialTrackList = new _TrackList.TrackList();
    ...
    Promise.all(stems).then(function (soundRequests) {
        ...
        var sounds = soundRequests.map(function (sound) {
            ...
            initialTrackList.addTrack(new _Channel.Channel(_Context.CONTEXT, sound.data));

            console.log(_typeof(sound.data));
        });
...
},{"./AudioComponents/Channel":1,"./AudioComponents/Context":2,"./AudioComponents/SoundBank":3,"./AudioComponents/TrackList":4,"./Helpers/Stems":5,"axios":7}],7:[function(require,module,exports){
